// ==UserScript==
// @name        ConnectionsCloudGeneralToneAnalysis
// @namespace   https://apps.na.collabserv.com/
// @description Provides the ability to highlight any text on Connections Cloud and get a tone analysis
// @include     https://apps.na.collabserv.com/*
// @exclude     https://mail.notes.na.collabserv.com/verse?
// @version     1
// @grant       GM_xmlhttpRequest
// ==/UserScript==

// ####################################################################
// Code related to the Analyze Tone button on the main user interface.
// ####################################################################
...
(function() {
    ...
    function analyzeConnectionsContent()
    {
        ...
        // Call Watson Tone Analyzer to perform analysis
    ...
    //
    // Make REST call to Watson Tone Analyzer to process content
    //
    function getConnectionsToneAnalysis(contentToAnalyze)
    {
        // alert('Calling Watson Tone Analyzer');
        var serviceID="cf122e60-86a9-46d0-9066-0a91502bb34f"; // Social Bluemix account
        var servicePassword="UtSZppEwGJG3";

        var postData = contentToAnalyze;
        var sizePostData = contentToAnalyze.length;
        ...
        GM_xmlhttpRequest({
            ...
            onload: function(response) { showConnectionsToneAnalysis(response.responseText); }
        });
    }
