...
//
// @name         iframe protocol matcher
// @version      0.4
// @description  *** PROTOTYPE CODE *** matches the iframe element's src protocol to that of the current page
//
...
if(typeof(dojo) != "undefined") {
	dojo.query("iframe[src^='http']").forEach(function(n,i){ n.src = location.protocol + n.src.substring(n.src.indexOf("://")+1); });
}