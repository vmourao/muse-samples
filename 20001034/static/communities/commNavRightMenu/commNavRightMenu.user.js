...
//
// @name         commNavRightMenu
// @version      0.6
// @description  *** PROTOTYPE CODE *** show/hide right column on a community
//
...
if(typeof(dojo) != "undefined") {
	dojo.place(
        "<style>"+
        "#lotusMain { padding-right:0; }"+
        "#lotusColRight { transition: width .5s; transition-timing-function: ease-in-out; overflow:hidden; }"+
        "#lotusColRight { width:5px; margin-left:0px; padding-left:10px;  }"+
        "#importantBookmarksSection, #widget-container-col3, #lotusColRight:hover { width:275px; }"+
        "</style>", 
